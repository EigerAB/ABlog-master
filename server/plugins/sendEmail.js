 ...
 *
 * @Description 邮件发送
 * 调用方法:sendMail('994718917@qq.com','这是测试邮件', 'Hi Apollo,这是一封测试邮件');
 * @Created 2023/04/05 15:10
...
const config = {
  email: {
    ...
    user: '2201044408@qq.com', // 你的QQ邮箱，用来发送回复邮件
    pass: 'dljsmfjbiazqdibd', // 你的QQ邮箱授权码，如何操作获取见README.md所述
  },
}
